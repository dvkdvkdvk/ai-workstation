...
```bash
curl -fsSL https://raw.githubusercontent.com/YOUR_USER/ai-workstation/main/install.sh | bash
```

Or download and run:

```bash
curl -O https://raw.githubusercontent.com/YOUR_USER/ai-workstation/main/install.sh
bash install.sh
```
